...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "Baluatar, Kathmandu",
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "kathmanduandhearing@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "+977 974-3290896",
  },
];
          ...
          <div>
            <div>
              <p className="text-[35px] max-lg:hidden font-semibold text-nowrap text-[#132238]">
                Let’s Talk About Your Hearing & Speech Care
              </p>
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                We’re here to help you improve your hearing, speech, and overall quality of life. Get in touch with us to book a consultation, or learn more about our services.
              </p>
            </div>
